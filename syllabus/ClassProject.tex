...
0) Basic functionality with DECaLS 
http://dlsvcs.datalab.noao.edu:8000/user/hjZLc6E5vLte/notebooks/Decals_Basic_Access.ipynb

1) Star/Galaxy/QSO Classification in DECaLS
http://dlsvcs.datalab.noao.edu:8000/user/hjZLc6E5vLte/notebooks/Decals-StarGalQso-Short.ipynb

2) Light curve plot (using the SMASH survey) 
http://datalab.noao.edu/notebooks/web/Time_series_analysis_of_a_RR_Lyrae_star.html
